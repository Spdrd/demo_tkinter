...
class t_oficinas_display(t_display):
    ...
    def __init__(self, app):
        ...
        entry_codigo = CTkEntry(frame, placeholder_text="Codigo de la oficina")
        ...
        label_nombre = CTkLabel(frame, text= "Oficina:")
        entry_nombre = CTkEntry(frame, placeholder_text="Nombre de la oficina")
