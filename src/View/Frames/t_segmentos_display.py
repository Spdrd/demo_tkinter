...
class t_segmentos_display(t_display):
    ...
    def __init__(self, app):
        ...
        entry_codigo = CTkEntry(frame, placeholder_text="Codigo del segmento")
        ...
        label_nombre = CTkLabel(frame, text= "Segmento:")
        entry_nombre = CTkEntry(frame, placeholder_text="Nombre del segmento")
